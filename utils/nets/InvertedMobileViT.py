...
class InvertedMobileViT(nn.Module):
    ...
    def __init__(self, in_features=64):
        ...
        self.MV5 = InvertedRedisual(in_channels=64, out_channels=64, strides=1)
        self.MV6 = InvertedRedisual(in_channels=64, out_channels=32, strides=1)

        self.MV7 = InvertedRedisual(in_channels=32, out_channels=16, strides=1)
